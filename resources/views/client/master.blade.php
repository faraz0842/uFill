        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            @endif
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    ...
                    <a href="{{ Route('client.shipment.delivery') }}">
                ...
                @if (session('package_name') == 'shipment')
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{Route('client.shipment.delivery')}}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">{{ trans('message.shipments') }}</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{Route('client.shipment.status_check')}}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{Route('client.billing',[session('client_id') , session('stripe_id')])}}">
                                    <span class="menu-icon">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ Route('client.overview') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ Route('client.referral') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ Route('client.profile',session('client_id')) }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{Route('client.package.shipment')}}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ Route('client.news') }}">
                                    <span class="menu-icon">
                            ...
                            @endphp
                            <div class="menu-item">
                                <a class="menu-link" href="{{ Route('client.changelog') }}">
                                    <span class="menu-icon">
                                    ...
                                    <span class="menu-title">{{ trans('message.changelog') }}
                                        {{ $changelog_version->version }}</span>
                                </a>
                            </div>
                        </div>
                        <!--end::Menu-->
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            <div class="menu-item">
                                                <a class="menu-link" href="#">
                                                    ...
                                                    <span class="menu-title">{{ trans('message.orders') }}</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="#">
                                                    ...
                                                    <span class="menu-title">{{ trans('message.returns') }}</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="#">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                                <span class="menu-link">
                                                    ...
                                                    <span class="menu-title">{{ trans('message.catalog') }}</span>
                                                    <span class="menu-arrow"></span>
                                                </span>
                                                <div class="menu-sub menu-sub-accordion">
                                                    <div class="menu-item">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="#">
                                                    ...
                                                    <span class="menu-title">{{ trans('message.customers') }}</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="#">
                                                    ...
                                                    <span class="menu-title">{{ trans('message.store analysis') }}</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="#">
                                                    ...
                                                    <span class="menu-title">{{ trans('message.course') }}</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="#">
                                            ...
                                            <span class="menu-title">{{ trans('message.social media') }}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">{{ trans('message.functions') }}</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="#" data-bs-toggle="tooltip"
                                            ...
                                            <span class="menu-title">Project Plans</span>
                                        </a>
                                    </div>
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                        <span class="menu-link">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="#">
                                                    ...
                                                    <span class="menu-title">The Invoice</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="../../demo1/dist/pages/course/courses.html">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/files/fil025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ Route('client.users') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ Route('client.settings') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Settings</span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ Route('client.api') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">APIs / Integration</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="#">
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                        ...
                        <div class="d-flex align-items-stretch flex-shrink-0">
                            ...
                            <div class="d-flex align-items-center ms-1 ms-lg-3" data-bs-toggle="tooltip"
                                title="{{ trans('message.logout_your_session') }}.">
                            ...
                            <div class="d-flex align-items-center ms-1 ms-lg-3">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-primary fw-bold py-4 fs-6 w-200px"
                                    ...
                                    <div class="menu-item px-3 my-1">
                                        <a href="{{ Route('change.theme.light') }}" class="menu-link px-3">
                                            <span class="menu-icon">
                                                <i class="fa fa-sun fs-2"></i>
                                            </span>
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3 my-1">
                                        <a href="{{ Route('change.theme.dark') }}" class="menu-link px-3">
                                            <span class="menu-icon">
                                                <i class="fa fa-moon fs-2"></i>
                                            </span>
                            ...
                            <!--begin::Theme mode-->
                            {{-- <div class="d-flex align-items-center ms-1 ms-lg-3" data-bs-toggle="tooltip" title="{{ trans('message.activate_dark_mode')}}.">
                                    <!--begin::Theme mode docs-->
                                    @if (session('theme') == 'dark')
                                        <a class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" href="{{Route('change.theme.light')}}">
                                            <i class="fonticon-sun fs-2"></i>
                                        </a>
                                    @elseif(session('theme') == 'light')
                                        <a class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" href="{{Route('change.theme.dark')}}">
                                            <i class="fonticon-sun fs-2"></i>
                                        </a>
                                    @else
                                        <a class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" href="{{Route('change.theme.dark')}}">
                            ...
                            <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-300px"
                                        ...
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="fw-bolder d-flex align-items-center fs-5">
                                                    {{ session('name') }}
                                                    <span
                                                        class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Client</span>
                                                </div>
                                                <div class="fw-bold text-muted fs-7">{{ session('email') }}</div>
                                            </div>
                                            <!--end::Username-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ Route('client.settings') }}"
                                            class="menu-link px-5">{{ trans('message.settings') }}</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    <div class="separator my-2"></div>
                                    ...
                                    <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                        ...
                                        <a href="#" class="menu-link px-5">
                                            <span class="menu-title position-relative">{{ trans('message.language') }}

                                                @if (session('locale') == 'en')
                                                    <span
                                                        class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ trans('message.english') }}
                                                        <img class="w-15px h-15px rounded-1 ms-2"
                                                            src="{{ asset('assets/media/flags/united-states.svg') }}"
                                                            alt="" /></span>
                                                @else
                                                    <span
                                                        class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ trans('message.german') }}
                                                        <img class="w-15px h-15px rounded-1 ms-2"
                                                ...
                                                <a href="{{ url('lang/en') }}" class="menu-link d-flex px-5">
                                                    <span class="symbol symbol-20px me-4">
                                                        <img class="rounded-1"
                                                            src="{{ asset('assets/media/flags/united-states.svg') }}"
                                                            alt="" />
                                                    </span>{{ trans('message.english') }}</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ url('lang/de') }}" class="menu-link d-flex px-5">
                                                    <span class="symbol symbol-20px me-4">
                                                        <img class="rounded-1"
                                                            src="{{ asset('assets/media/flags/germany.svg') }}"
                                                            alt="" />
                                                    </span>{{ trans('message.german') }}</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu sub-->
                                    ...
                                    <div class="menu-item px-5 my-1">
                                        <a href="{{ Route('help.overview') }}"
                                            class="menu-link px-5">{{ trans('message.help_center') }}</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <div class="separator my-2"></div>
                                    <!--end::Menu separator-->
                                ...
                                {{-- <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-300px"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="{{ Route('admin.profile', session('id')) }}"
                                                class="menu-link px-5">{{ trans('message.my_profile') }}</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @php
                                            $incomplete_tasks = App\Models\AdminTask::where('assigned_to', session('name'))
                                                ->where('status', 'incomplete')
                                                ->count();
                                            //$incomplete_tasks = 0;
                                        @endphp
                                        <div class="menu-item px-5">
                                            <a href="{{ Route('admin.tasks', session('id')) }}" class="menu-link px-5">
                                                <span class="menu-text">{{ trans('message.my_tasks') }}</span>
                                                <span class="menu-badge">
                                                    @if ($incomplete_tasks <= 0)
                                                        <span
                                                            class="badge badge-light-success badge-circle fw-bolder fs-7">{{ $incomplete_tasks }}</span>
                                                    @elseif($incomplete_tasks <= 10)
                                                        <span
                                                            class="badge badge-light-warning badge-circle fw-bolder fs-7">{{ $incomplete_tasks }}</span>
                                                    @else
                                                        <span
                                                            class="badge badge-light-danger badge-circle fw-bolder fs-7">{{ $incomplete_tasks }}</span>
                                                    @endif
                                                </span>
                                            </a>
                                        </div>
                                        ...
                                        <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                            data-kt-menu-placement="left-start">
                                            <a href="#" class="menu-link px-5">
                                                <span class="menu-title position-relative">{{ trans('message.Status') }}

                                                    @if (session('status') == 'online')
                                                        <span
                                                            class="fs-8 rounded text-white bg-success px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ session('status') }}</span>
                                                    @elseif(session('status') == 'away')
                                                        <span
                                                            class="fs-8 rounded text-white bg-warning px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ session('status') }}</span>
                                                    @elseif(session('status') == 'busy')
                                                        <span
                                                            class="fs-8 rounded text-white bg-danger px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ session('status') }}</span>
                                                    @elseif(session('status') == 'do not disturb')
                                                        <span
                                                            class="fs-8 rounded text-white bg-danger px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ session('status') }}</span>
                                                    @endif
                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{ Route('admin.change.status', 'online') }}"
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{ Route('admin.change.status', 'away') }}"
                                                        class="menu-link d-flex px-5">
                                                        <span class="symbol symbol-20px me-4">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ Route('admin.change.status', 'busy') }}"
                                                        class="menu-link d-flex px-5">
                                                        <span class="symbol symbol-20px me-4">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ Route('admin.change.status', 'do not disturb') }}"
                                                        class="menu-link d-flex px-5">
                                                        <span class="symbol symbol-20px me-4">

                                                        </span>Do not disturb</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu sub-->
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://ufill.de/" target="_blank"
                                class="text-gray-800 text-hover-primary">uFill - The eCom Solution</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
                        <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
                            <li class="menu-item">
                                <a href="https://ufill.de/" target="_blank" class="menu-link px-2">uFill</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://ufill.de/rechtliches" target="_blank"
                                    class="menu-link px-2">{{ trans('message.legal') }}</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://ufill.de/agb" target="_blank" class="menu-link px-2">{{ trans('message.terms and conditions') }}</a>
                            </li>
                        </ul>
                        <!--end::Menu-->
                    </div>
