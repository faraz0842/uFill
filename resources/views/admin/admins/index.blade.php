                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                <!--begin::Description-->
                                <small class="text-muted fs-7 fw-bold my-1 ms-1">{{trans('message.admin')}} > {{trans('message.User Management')}} > {{trans('message.admins')}}</small>
                                <!--end::Description-->
                            </div>
                            <!--end::Page title-->
                            <!--begin::Wrapper-->
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                            <!--begin::Add user-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">{{trans('message.New Administrator')}}</button>
                                            <!--end::Add user-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-user-table-toolbar="selected">
                                            ...
                                            <button type="button" class="btn btn-danger" data-kt-user-table-select="delete_selected">{{trans('message.Delete selected')}}.</button>
                                        </div>
                                        <!--end::Group actions-->
                                                        ...
                                                        <form  class="form" action="{{Route('admin.store')}}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll"
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <!--begin::Label-->
                                                                    <label class="d-block fw-bold fs-6 mb-5">{{trans('message.Profile')}}</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Image input-->
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <!--begin::Label-->
                                                                    <label class=" fw-bold fs-6 mb-2">{{trans('message.First Name')}}</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Emma" value="{{old('first_name')}}" />
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <!--begin::Label-->
                                                                    <label class=" fw-bold fs-6 mb-2">{{trans('message.Surname')}}</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="surname" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Smith" value="{{old('surname')}}" />
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <!--begin::Label-->
                                                                    <label class=" fw-bold fs-6 mb-2">{{trans('message.E-Mail')}}</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <!--begin::Label-->
                                                                    <label class=" fw-bold fs-6 mb-2">{{trans('message.Password')}}</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="password" name="password" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Password" value="{{old('password')}}" />
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <!--begin::Label-->
                                                                    <label class=" fw-bold fs-6 mb-2">{{trans('message.Phone')}}</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="tel" name="phone" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="+49 541 231 458 1" value="{{old('phone')}}" />
                                                                    @if($errors->has('phone'))
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <!--begin::Label-->
                                                                    <label class=" fw-bold fs-6 mb-2">{{trans('message.Mobile')}}</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="tel" name="mobile" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="+49 171 231 458 1" value="{{old('mobile')}}" />
                                                                ...
                                                                <div class="row g-9 mb-7">
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="fs-6 fw-bold mb-2 ">{{trans('message.Street')}}</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input class="form-control form-control-solid" placeholder="Musterstraße" name="street" value="{{old('street')}}" />
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="fs-6 fw-bold mb-2 ">{{trans('message.House Number')}}</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input class="form-control form-control-solid" placeholder="12A" name="house_number" value="{{old('house_number')}}" />
                                                                ...
                                                                <div class="row g-9 mb-7">
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        ...
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input typ="number" class="form-control form-control-solid" placeholder="49123" name="zip_code" value="{{old('zip_code')}}" />
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        ...
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input class="form-control form-control-solid" placeholder="Musterort" name="city" value="{{old('city')}}" />
                                                                        @if($errors->has('city'))
                                                                ...
                                                                <div class="d-flex flex-column mb-7 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <select name="country" aria-label="Select..." data-control="select2" data-placeholder="Select..." class="form-select form-select-solid" data-dropdown-parent="#kt_modal_add_user" >
                                                                ...
                                                                <div class="fv-row mb-15">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <select name="language" aria-label="Select..." data-control="select2" data-placeholder="Select..." class="form-select form-select-solid" data-dropdown-parent="#kt_modal_add_user" >
																	<option></option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex ">
                                                    ...
                                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                        <div class="symbol-label">
                                                            @if ($item->profile_picture)
                                                                <img src="{{URL::asset($item->profile_picture)}}" alt="{{$item->name}}" class="w-100" />
                                                            @else

                                                            <img src="{{asset('assets/media/svg/avatars/blank.svg')}}" alt="{{$item->name}}" class="w-100" />
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="{{Route('admin.profile',$item->admin_id)}}">{{$item->name}}<br>{{$item->email}}</a>
                                                        </span>
                                                    </div>
                                                    <!--begin::User details-->
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <span class="badge badge-success fs-8 fw-bolder"  >{{$item->status}}</span>
                                                    @elseif($item->status == 'away')
                                                        <span class="badge badge-warning fs-8 fw-bolder"  >{{$item->status}}</span>
                                                    ...
                                                    @elseif($item->status == 'offline')
                                                        <span class="badge  fs-8 fw-bolder" style="background-color: grey" >{{$item->status}}</span>
                                                    @endif
                                                </td>

                                                <!--begin::Action=-->
                                                <td class="text-center">
                                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">{{ trans('message.Actions') }}
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{Route('admin.delete',$item->admin_id)}}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                                    <!--end::Menu-->
