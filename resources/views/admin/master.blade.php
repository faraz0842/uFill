...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
                    ...
                    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ trans('message.user_management') }}</span>
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ Route('admin.clients') }}">
                                        ...
                                        <span class="menu-title">{{ trans('message.clients') }}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ Route('admin.referral') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ trans('message.affiliate_program') }}</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ Route('admin.api') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ trans('message.apis/integration') }}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="menu-item">
                            <div class="menu-content pb-2">
                                <span
                                    class="menu-section text-muted text-uppercase fs-8 ls-1">{{ trans('message.other') }}</span>
                            </div>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="{{ Route('admin.courses') }}">
                                <span class="menu-icon">
                        ...
                        @endphp
                        <div class="menu-item">
                            <a class="menu-link" href="{{ Route('admin.changelog') }}">
                                <span class="menu-icon">
            ...
            <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
                <a href="{{ Route('help.overview') }}" class="btn btn-custom btn-primary w-100"
                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click"
                    title="Need help? Take a look at our wiki or contact our customer support.">
                    <span class="btn-label">uFill Support-Center</span>
                        ...
                        <div class="d-flex align-items-stretch" id="kt_header_nav">
                            ...
                            <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                ...
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                                    ...
                                    <!--begin::Description-->
                                    <small
                                        class="text-muted fs-7 fw-bold my-1 ms-1">{{ trans('message.uFill') }}</small>
                                    <!--end::Description-->
                                </h1>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-300px"
                                    ...
                                    <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                        ...
                                        <a href="#" class="menu-link px-5">
                                            <span
                                                class="menu-title position-relative">{{ trans('message.language') }}
                                    ...
                                    <!--begin::Menu item-->
                                    {{-- <div class="menu-item px-5">
                                            <a href="#" class="menu-link px-5">Abmelden</a>
                                        </div> --}}
                                    <!--end::Menu item-->
                                    {{-- <div class="menu-item px-5">
                ...
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="https://ufill.de/" target="_blank"
                            class="text-gray-800 text-hover-primary">{{ trans('message.ufill_solution') }}</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Menu-->
                    <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
                        <li class="menu-item">
                            <a href="https://ufill.de/" target="_blank"
                                class="menu-link px-2">{{ trans('message.uFill') }}</a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="https://ufill.de/agb" target="_blank"
                                class="menu-link px-2">{{ trans('message.agb') }}</a>
                        </li>
                    </ul>
                    <!--end::Menu-->
                </div>
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="card shadow-none rounded-0">
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="#" class="btn btn-bg-body text-primary">View
                    All Activities
    ...
    {{-- <script src="{{asset('assets/js/custom/documentation/editors/tinymce/basic.js')}}"></script> --}}
    ...
    <script>
        function changeTaskStatus(arr) {
            if ($('#' + arr[1]).is(':checked')) {
                $('#' + arr[2]).css("text-decoration", "line-through");
                $.ajax({
                    url: "{{ Route('client.admin.updatestatus') }}",
                    method: "GET",
                    data: {
                        task_id: arr[0],
                        status: 'complete'
                ...
                $('#' + arr[2]).css("text-decoration", "none");
                $.ajax({
                    url: "{{ Route('client.admin.updatestatus') }}",
                    method: "GET",
                    data: {
